...
-Η τρέχουσα έκδοση περιλαμβάνει ένα σύνολο απο reduction functions αλλα η υποδομή είναι επαρκής
 ...
 Αντιστοιχίζει ώς εξής:
  ...
  > 2ο σύνολο συναρτήσεων "Μέγιστη Εντροπία Χαρακτήρων" [992 αμιγώς διαφορετικές]
    -----------------------------------------------------------------------------
	Κάθε μία επιλέγει 6 bytes του hash και εφαρμόζωντας modulo αριθμητική τα αντιστοιχίζει
	σε έναν απο τους 64 χαρακτήρες του "αλφάβητου" για τον κωδικό.
	
	Οι 992 συναρτήσεις χωρίζονται σε 31 "κλάσσεις". Κάθε μία απο αυτές τις κλάσσεις
	περιλαμβάνει 32 διαφορετικές συναρτήσεις, η θέση κάθε μίας μέσα στην κλάσση 
	καθορίζει το byte που θα επιλεγεί πρώτο. Π.χ.
		1η ξεκινάει αντιστοιχίζοντας το byte[0]
		2η ξεκινάει αντιστοιχίζοντας το byte[2]
		...
		
	Έπειτα, το επόμενο και κάθε επόμενο byte επιλέγεται προσθέτωντας στον τρέχοντα
	δείκτη τον αριθμό της κλάσσης της συνάρτησης, παλι γυρίζοντας κυκλικά στην αρχή
	μετα το byte[31]. Ετσι τελικά:
		Για την 2η κλάσση, η σύνάρτηση #28 επιλέγει τα bytes[28-30-0-2-4-6]

    
	
  > 3ο σύνολο συναρτήσεων "Mix 'n' Match" [32 αμιγώς διαφορετικές]
    --------------------------------------------------------------
    Προέκυψε "ανακατέυοντας" χαρακτηριστικά απο τις προηγούμενες τεχνικές.
	Διαφέρει απο τις άλλες καθώς πέτυχε πραγματική εντροπία εξόδου.
	
	

  > 4ο σύνολο συναρτήσεων "Human-Like" (προς μελλοντική υλοποίηση)
    --------------------------------------------------------------
