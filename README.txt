...
την "Ισορροπία Χρόνου-Μνήμης" (Time-Memory Tradeoff) μιας τέτοιας επίθεσης, σε συνδυασμό
με ένα πλήθος επιλογών παραμετροποίησης.
...
-Yποστήριξη περισσότερων του ενός πινάκων για να μεγαλώσουν οι πιθανότητες σύμφωνα με τους 
τύπους των Hellman, Oechslin (βλ. αντίστοιχο Συνδεσμο)
-Νεο σύνολο απο Reduction Functions που λαμβάνοντας υπόψιν το αλφάβητο του κωδικού θα 
οδηγεί σε πιο τυχαία και ομοιόμορφα αποτελέσματα.
-Παραλληλισμός για την δημιουργία του πίνακα. Ενω είναι η πιο χρονοβόρα διαδικασία 
δεν αξιοποιέι τις δυυνατότητες παραλληλισμού του συστήματος. Μια υλοποίηση με pthreads θα 
αύξανε  κατακόρυφα την αποδοτικότητα του προγράμματος.
-Διερεύνηση του κώδικα για επικύνδυνα buffer overflows και "μπάλωμά" τους (patching) για 
λόγους ασφαλείας. (Βλέπετε την ειρωνεία εδώ? :D )
-Έλεγχος της δέσμευσης μνήμης με το valgrind και αποδέσμευση όπου χρείζεται.
