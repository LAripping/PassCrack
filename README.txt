...
-Η τρέχουσα έκδοση περιλαμβάνει ένα σύνολο απο reduction functions αλλα η υποδομή είναι επαρκής
 ...
 Αντιστοιχίζει ώς εξής:
  ...
  > 2ο σύνολο συναρτήσεων "Intra-password entropy" [992 αμιγώς διαφορετικές]
    ------------------------------------------------------------
  ...
  > 4ο σύνολο συναρτήσεων "PRNG/Uniform" [απειρες αμιγώς διαφορετικές]
    ------------------------------------------------------------
    Seed απο red_by
    prng δίνει indices στο hash
    τα bytes με αυτα τα indices γίνονται mod64 για να αντιστοιχιστούν στο αλφάβητο
